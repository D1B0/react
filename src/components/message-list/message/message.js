...
import {deleteMessageFB, startEdit, startEditMessageFB} from '../../../store/messages';
            ...
            <div className={styles.editor}>
                <ListItemIcon>
                    <BorderColor
                        ...
                        onClick={() => {
                            dispatch (startEdit ())
                            dispatch (startEditMessageFB (roomId, message, id))
                        }}
                    />
                </ListItemIcon>
                <ListItemIcon>
                    <HighlightOff
                        className={styles.icon}
                        onClick={() => dispatch (deleteMessageFB (roomId, id))}
                    />
                </ListItemIcon>
            </div>
        </div>
